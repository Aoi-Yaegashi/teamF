...
class ProductRepositoryTest {
    ...
    void saveAndFindById_Success() {
        ...
        Integer savedId = savedProduct.getId(); // 生成されたIDを取得
    ...
    void findById_WhenProductsExists_ShouldReturnProducts() {
        ...
        // Act
        Optional<Product> foundProductOpt = productRepository.findById(product1.getId());
    ...
    void decreaseStock_Fail_InsufficientStock() {
        // Arrange
        Integer productId = product2.getId();
